...
import com.system_share_documents.UserService.security.KeycloakGrantedAuthoritiesConverter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:5173")); // FE React/Vite
